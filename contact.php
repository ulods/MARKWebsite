...
$address = "enquiry@markdevelopers.com";
...
$e_body = "You have been contacted by $name with regards to $subject studying in $college in $branch, their additional message is as follows." . PHP_EOL . PHP_EOL;
